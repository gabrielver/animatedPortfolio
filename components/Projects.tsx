        ...
        <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80 '>
                {projects.map((project, i) => (
                    <div className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'> 
                        ...
                        viewport={{once: true}}
                        src="https://imgs.search.brave.com/1G4qsRkVD-dj2d-D4UBJW9lCAAsKwPz4cbe65KEaSNA/rs:fit:653:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5q/d1pZQ29rQUtZN0x0/czZTNkt1aWpBSGFG/WSZwaWQ9QXBp" alt="" />
